...
public class JodaTest {
    ...
    public static void main(String[] args) {
        ...
        // 年,月,日,时,分,秒,毫秒
        DateTime dt3 = new DateTime(2012, 12, 13, 10, 30, 50, 333);// 2010年2月13日10点30分50秒333毫秒
        ...
        //计算两个日期间隔的天数
        LocalDate start=new LocalDate(2012, 05,01);
        LocalDate end=new LocalDate(2012, 05, 15);
        int days = Days.daysBetween(dateTime, dt3).getDays();
