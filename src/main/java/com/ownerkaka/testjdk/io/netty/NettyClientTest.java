package com.ownerkaka.testjdk.io.netty;

import com.ownerkaka.testjdk.common.entity.Constants;
import com.ownerkaka.testjdk.io.netty.handler.SubscribeClientHandler;
...
public class NettyClientTest {
    ...
    public void clientStart() {
        try {
            ...
            ChannelFuture channelFuture = boot.connect("127.0.0.1", Constants.port).sync();
